...
public final class ClientChainData implements LoginChainData {
    ...
    private SimpleBinaryStream chainData;
    private SimpleBinaryStream skinData;

    public ClientChainData(byte[] chainData, byte[] skinData) {
        this.chainData = new SimpleBinaryStream(chainData, 0);
        this.skinData = new SimpleBinaryStream(skinData, 0);
        decodeChainData();
        decodeSkinData();
    }
    ...
    private void decodeSkinData() {
        JsonObject skinToken = decodeToken(new String(skinData.getBuffer()));
    ...
    private void decodeChainData() {
        Map<String, List<String>> map = new Gson().fromJson(new String(chainData.getBuffer(), StandardCharsets.UTF_8),
